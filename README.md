...
可愛海島風的撲克牌「心臟病」。系統輪流自動翻牌、同時喊 1、2、3……13，
翻出來的點數跟喊的數字一樣就趕快拍（喊 1～13；A＝1、J＝11、Q＝12、K＝13），最慢（或拍錯）的人收走整疊牌，先把牌出完的人獲勝。

- 一副 52 張、沒有鬼牌；系統排好座位順序，一人一張輪流發完
- 每次收牌後由收牌者按「自動發牌」，並從 1 重新喊
- 結束方式二選一（線上由房主決定、單機開局前選）：有人出完就結束／打到只剩一人有牌（出完的人依序拿名次離場）
- 單機：跟 1～3 個電腦玩，四段難度（幼幼班／簡單／普通／困難）
- 線上：2～4 人房間、電腦補位、觀戰（上限 20 人）、邀請連結、聊天室、斷線重連
- 手機／平板／桌機直橫向都能玩；右上角設定可調音樂、音效、喊數語音、震動、減少動態、喊數字特大；撲克牌是標準配色（紅心、方塊紅色，黑桃、梅花黑色）
...
內建錄音（`public/js/voice-clips.js`，用開源 espeak-ng 離線合成 一、二……十三共 13 段，跟翻牌同時念出）
